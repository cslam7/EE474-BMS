...
void screenBattery(bool *contactState, bool *toggleFlag, bool *setBattery, bool *oldContact, Elegoo_TFTLCD *tftPtr) {
    /****************
...
void displayTask(void* mData) {
    ...
    *****************/
    ...
    screenAlarm(data->hvilAlarm, data->currentAlarm, data->voltageAlarm, data->currentAlarmFlag, 
        ...
        screenBattery(data->contactState, data->toggleFlag, data->setBattery, data->oldContact, data->tft);
    }
