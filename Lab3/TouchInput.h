...
typedef struct touchInputTaskData {
    ...
    bool *setMeasure, *setAlarm, *setBattery;            // condition to set up formatting for respective screens
...
void getInput(int *screenNum, bool *toggleFlag, bool *setMeasure, bool *setAlarm, bool *setBattery,
